...
## Расширенный производственный контур (подготовлено)
Добавлены каркасы модулей и API health-endpoints для следующих контуров:
- `/production-data`
- `/portfolio`
- `/orders-history`
- `/planning`
...
Это заготовка под этапы 2–8 большого ТЗ: следующими шагами заполняются модели, схемы импорта, валидации и отчеты по каждому модулю.
