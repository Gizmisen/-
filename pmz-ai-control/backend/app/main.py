...
from app.models import extended_contour, imports, master_data, materials, orders, production_fact, production_plan, users
from app.routers import ai, auth, dashboard, fact, imports as imports_router, labor_fact, master_data, materials, orders, orders_history, plan_fact, plan_versions, planning, portfolio, production_data, sales, sap, templates, ui, warehouse
