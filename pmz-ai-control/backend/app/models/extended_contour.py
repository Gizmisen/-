...
class OrderPortfolio(Base):
    ...
    registration_date: Mapped[str | None] = mapped_column(Date)
    planning_variant: Mapped[str | None] = mapped_column(String(64))
    order_number: Mapped[str] = mapped_column(String(64), nullable=False)
    order_open_date: Mapped[str | None] = mapped_column(Date)
    ...
    planned_delivery_date: Mapped[str | None] = mapped_column(Date)
    actual_delivery_date: Mapped[str | None] = mapped_column(Date)
